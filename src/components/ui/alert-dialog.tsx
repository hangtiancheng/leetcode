...
function AlertDialogContent({
	...
	return (
		<BaseAlertDialog.Portal>
			<BaseAlertDialog.Backdrop className="fixed inset-0 z-50 bg-[#181a1f]/44 backdrop-blur-[2px] transition-opacity duration-180 ease-[ease] data-[ending-style]:opacity-0 data-[starting-style]:opacity-0" />
			<BaseAlertDialog.Popup
				className={cn(
					"fixed top-1/2 left-1/2 z-50 w-[min(440px,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-line bg-paper-raised p-6 shadow-[0_28px_70px_rgba(24,26,31,0.22)] outline-none",
